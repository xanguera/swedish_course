...
(function () {
  ...
  I.registerContent("pt", {
    vocab: {
      ...
      // Unit 3 — numbers
      noll: t("zero (0)"), ett: t("um (1)", "Também é o artigo 'ett'."),
      tva: t("dois (2)"), tre: t("três (3)"), fyra: t("quatro (4)"), fem: t("cinco (5)"),
      sex: t("seis (6)"), sju: t("sete (7)", "O som 'sju' é um 'h' suave — muito sueco!"),
      atta: t("oito (8)"), nio: t("nove (9)"), tio: t("dez (10)"),
      elva: t("onze (11)"), tolv: t("doze (12)"), tretton: t("treze (13)", "'-ton' marca os números 13–19."),
      fjorton: t("catorze (14)"), femton: t("quinze (15)"), sexton: t("dezasseis (16)"),
      sjutton: t("dezassete (17)"), arton: t("dezoito (18)"), nitton: t("dezanove (19)"),
      tjugo: t("vinte (20)", "O 'tj' é um som suave, tipo 'ch'."),
      trettio: t("trinta (30)"), fyrtio: t("quarenta (40)"), hundra: t("cem (100)", "'ett hundra' = cem."),
