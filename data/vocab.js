...
(function () {
  ...
  add({ id: "noll",  sv: "noll",  en: "zero (0)",  ipa: "nɔlː",       img: "0", note: "", tags: ["u3","numbers"] });
  add({ id: "ett",   sv: "ett",   en: "one (1)",   ipa: "ɛtː",        img: "1", note: "Also the 'ett-word' article.", tags: ["u3","numbers"] });
  add({ id: "tva",   sv: "två",   en: "two (2)",   ipa: "tvoː",       img: "2", note: "", tags: ["u3","numbers"] });
  add({ id: "tre",   sv: "tre",   en: "three (3)", ipa: "treː",       img: "3", note: "", tags: ["u3","numbers"] });
  add({ id: "fyra",  sv: "fyra",  en: "four (4)",  ipa: "ˈfyːra",     img: "4", note: "", tags: ["u3","numbers"] });
  add({ id: "fem",   sv: "fem",   en: "five (5)",  ipa: "fɛm",        img: "5", note: "", tags: ["u3","numbers"] });
  add({ id: "sex",   sv: "sex",   en: "six (6)",   ipa: "sɛks",       img: "6", note: "", tags: ["u3","numbers"] });
  add({ id: "sju",   sv: "sju",   en: "seven (7)", ipa: "ɧʉː",        img: "7", note: "The 'sju' sound is a soft 'hw' — very Swedish!", tags: ["u3","numbers"] });
  add({ id: "atta",  sv: "åtta",  en: "eight (8)", ipa: "ˈɔtːa",      img: "8", note: "", tags: ["u3","numbers"] });
  add({ id: "nio",   sv: "nio",   en: "nine (9)",  ipa: "ˈniːɔ",      img: "9", note: "", tags: ["u3","numbers"] });
  add({ id: "tio",   sv: "tio",   en: "ten (10)",  ipa: "ˈtiːɔ",      img: "10", note: "", tags: ["u3","numbers"] });
  add({ id: "elva",    sv: "elva",    en: "eleven (11)",    ipa: "ˈɛlːva",   img: "11", note: "", tags: ["u3","numbers2"] });
  add({ id: "tolv",    sv: "tolv",    en: "twelve (12)",    ipa: "tɔlv",     img: "12", note: "", tags: ["u3","numbers2"] });
  add({ id: "tretton", sv: "tretton", en: "thirteen (13)",  ipa: "ˈtrɛtːɔn", img: "13", note: "-ton = teen.", tags: ["u3","numbers2"] });
  add({ id: "fjorton", sv: "fjorton", en: "fourteen (14)",  ipa: "ˈfjʊrtɔn", img: "14", note: "", tags: ["u3","numbers2"] });
  add({ id: "femton",  sv: "femton",  en: "fifteen (15)",   ipa: "ˈfɛmtɔn",  img: "15", note: "", tags: ["u3","numbers2"] });
  add({ id: "sexton",  sv: "sexton",  en: "sixteen (16)",   ipa: "ˈsɛkstɔn", img: "16", note: "", tags: ["u3","numbers2"] });
  add({ id: "sjutton", sv: "sjutton", en: "seventeen (17)", ipa: "ˈɧɵtːɔn",  img: "17", note: "", tags: ["u3","numbers2"] });
  add({ id: "arton",   sv: "arton",   en: "eighteen (18)",  ipa: "ˈɑːʈɔn",   img: "18", note: "", tags: ["u3","numbers2"] });
  add({ id: "nitton",  sv: "nitton",  en: "nineteen (19)",  ipa: "ˈnitːɔn",  img: "19", note: "", tags: ["u3","numbers2"] });
  add({ id: "tjugo",   sv: "tjugo",   en: "twenty (20)",    ipa: "ˈɕʉːɡʊ",   img: "20", note: "The 'tj' is a soft 'sh/ch' sound.", tags: ["u3","numbers2"] });
  add({ id: "trettio", sv: "trettio", en: "thirty (30)",    ipa: "ˈtrɛtːiɔ", img: "30", note: "", tags: ["u3","numbers2"] });
  add({ id: "fyrtio",  sv: "fyrtio",  en: "forty (40)",     ipa: "ˈfœʈːiɔ",  img: "40", note: "", tags: ["u3","numbers2"] });
  add({ id: "hundra",  sv: "hundra",  en: "hundred (100)",  ipa: "ˈhɵndra",  img: "💯", note: "'ett hundra' = one hundred.", tags: ["u3","numbers2"] });
