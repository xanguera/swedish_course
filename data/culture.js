/* culture.js — "Visste du?" (Did you know?) cards.
   ...
   Each: id, emoji, title, sv (a Swedish keyword), body (HTML allowed). */
(function () {
  "use strict";
  var C = [
    { id: "fika", emoji: "☕", title: "Fika is sacred", sv: "fika",
    ...
    { id: "lagom", emoji: "⚖️", title: "Lagom — not too much, not too little", sv: "lagom",
    ...
    { id: "pippi", emoji: "🧒", title: "Pippi Longstocking is Swedish", sv: "Pippi Långstrump",
    ...
    { id: "pant", emoji: "♻️", title: "Get money back for bottles", sv: "pant",
    ...
    { id: "cashless", emoji: "💳", title: "Sweden is almost cashless", sv: "kort",
    ...
    { id: "tbana_art", emoji: "🎨", title: "The world's longest art gallery", sv: "tunnelbana",
    ...
    { id: "allemansratten", emoji: "🌲", title: "The right to roam", sv: "allemansrätten",
    ...
    { id: "kanelbullens_dag", emoji: "🥐", title: "Cinnamon Bun Day", sv: "Kanelbullens dag",
    ...
    { id: "semla", emoji: "🧁", title: "The cream bun of spring", sv: "semla",
    ...
    { id: "surstromming", emoji: "🐟", title: "The world's smelliest fish", sv: "surströmming",
    ...
    { id: "vasa", emoji: "🚢", title: "A warship that sank in minutes", sv: "Vasamuseet",
    ...
    { id: "midsommar", emoji: "🌸", title: "Dancing around the pole", sv: "midsommar",
  ...
  LSV.data.culture = C;
  LSV.data.cultureById = {};
  C.forEach(function (c) { LSV.data.cultureById[c.id] = c; });
})();
